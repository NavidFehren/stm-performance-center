...
const classTypes = ["All", "MMA", "BJJ", "Striking", "S&C", "Youth"];
    ...
    <section id="schedule" className="section-padding bg-gradient-dark">
      <div className="container-custom">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <span className="text-primary font-display uppercase tracking-widest text-sm">Weekly Schedule</span>
          <h2 className="text-4xl md:text-5xl font-display font-bold mt-4 mb-6">
            TRAIN ON <span className="gradient-text">YOUR TIME</span>
          </h2>
          <p className="text-muted-foreground text-lg">
            With over 50 classes per week, we've got a training time that fits your schedule.
          </p>
        </div>
          ...
          <table className="w-full min-w-[800px]">
            <thead>
              <tr className="border-b border-border">
                <th className="text-left py-4 px-3 font-display font-semibold text-muted-foreground">Time</th>
                {days.map((day) => (
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mt-8 pt-8 border-t border-border">
          <div className="flex flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">S&C/Open Gym</span>
            </div>
            <div className="flex items-center gap-2">
