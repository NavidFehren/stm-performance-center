...
const OptionBCarousel = () => (
  <div className="mb-32">
    ...
    <div className="mb-12">
      ...
      <div className="lg:hidden overflow-x-auto scrollbar-hide touch-pan-x -mx-4 px-4 py-2">
    ...
    <div className="mb-12">
      ...
      <div className="md:hidden overflow-x-auto scrollbar-hide touch-pan-x -mx-4 px-4 py-2">
        <div className="flex gap-4" style={{ width: 'max-content' }}>
    ...
    <div>
      ...
      <div className="sm:hidden overflow-x-auto scrollbar-hide touch-pan-x -mx-4 px-4 py-2">
        <div className="flex gap-4" style={{ width: 'max-content' }}>
